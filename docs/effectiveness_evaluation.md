...
| Неподдерживаемый SQL ClickHouse | ClickHouse | неподдерживаемый диалект | `clickhouse` | 2 | 0 | 0 | 0 | 2 | 0.00 | 0.00 |
| Неподдерживаемый SQL Hive | Hadoop/Hive | неподдерживаемый диалект | `hive` | 1 | 0 | 0 | 0 | 1 | 0.00 | 0.00 |
...
| ClickHouse | 2 | 0 | 0 | 0 | 2 | 0.00 | 0.00 | 0.00 |
| Greenplum | 4 | 0 | 0 | 0 | 4 | 0.00 | 0.00 | 0.00 |
| Hadoop/Hive | 1 | 0 | 0 | 0 | 1 | 0.00 | 0.00 | 0.00 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Базовые поддерживаемые сценарии | 12 | 8 | 8 | 0 | 4 | 1.00 | 0.67 | 0.80 |
| Сложные SQL-конструкции | 7 | 4 | 2 | 2 | 5 | 0.50 | 0.29 | 0.36 |
| Неподдерживаемые SQL-диалекты | 3 | 0 | 0 | 0 | 3 | 0.00 | 0.00 | 0.00 |
...
- для ClickHouse и Hive SQL-зависимости не извлекаются, так как эти диалекты не входят в список поддерживаемых `SqlParser`;
